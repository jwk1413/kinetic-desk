...
(async()=>{
 ...
 function run(hz,fps,paused,bench,mouse,jitter=false) {
  ...
  sandbox.window={innerWidth:700,innerHeight:720,devicePixelRatio:2,addEventListener:(k,fn)=>listeners[k]=fn,desk:{getState:()=>undefined,onState:fn=>stateListener=fn,ready:()=>stateListener(state),setClickThrough(){},moveWindowBy(){},setObjectAnchor(){},onWindowBounds(){return()=>{}},getWindowBounds(){return Promise.resolve({x:0,y:0})}}};
